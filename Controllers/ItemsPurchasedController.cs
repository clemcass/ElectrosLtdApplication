    ...
    public class ItemsPurchasedController : Controller
    {
        ...
        public ActionResult ItemsPurchased()
        {
            try
            {
                ...
                return Json("Sorry but an error occured : " + e.Message );
            }
        ...
        public ActionResult Details(int id )
        {
            ...
            try
            {
                ...
                if (f != null)
                {
                    fm.FaultTrackList = new FaultTrackServ.FaultTrackServiceClient().GetFaultTracksByFaultId(f.FaultId).ToList();
                }
        ...
        [Authorize(Roles = "User")]
        [HttpPost]
        public ActionResult Print(string id, string  start,string end)
        {
