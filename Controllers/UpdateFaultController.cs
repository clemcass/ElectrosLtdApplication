...
namespace ElectrosLtdApplication.Controllers
{
    public class UpdateFaultController : Controller
    {
        ...
        [Authorize(Roles = "Admin")]
        [HttpPost]
        public ActionResult FilterFault(string from, string to, string clientId, string faultId ,String sort)
        {
       ...
       [Authorize(Roles = "Admin")]
        ...
        {
            List<FaultTrack> faults = new FaultTrackServ.FaultTrackServiceClient().GetAllFaultTracks().ToList();
        ...
        public ActionResult UpdateFault(FaultTrackModel faultTrack)
        {
           ...
           // sms.sendmsg("", 3473164, true, "clementina", "OcPOfKPODFWTMg", "bla", numTo, "35679009492", 1, false, 0, false, 7, false, 7, true, 1, false, 1, false, 3, true, 0, true, 0, false,"3473164", 0, false, "SMS_TEXT", "Fault", "String", 1440, true);
            ...
            //commented
            sms.sendmsg("", 3480178, true, "clementina", "OcPOfKPODFWTMg", faultTrack.Type, numTo, "35679009492", 1, false, 0, false, 7, false, 7, true, 1, false, 1, false, 3, true, 0, true, 0, false, "3480178", 0, false, "SMS_TEXT", "Fault", "String", 1440, true);
            ...
            clientSMS.QueryString.Add("text", faultTrack.Type);
